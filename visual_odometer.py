...
class SimpleVisualOdometer:
    ...
    def __init__(self, **kwargs):
        ...
        self.im_trans_y_range = kwargs.pop("im_trans_y_range", 100:120)
        self.im_rot_y_range = kwargs.pop("im_rot_y_range", 75:240)
        self.im_odo_x_range = kwargs.pop("im_odo_x_range", 200:460)
    ...
    def estimate_odometry(self, im):
        ...
        rot = min_offset * degrees_per_pixel * PI / 180.
